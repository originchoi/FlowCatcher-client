...
프로젝트를 진행하며 스스로 많이 뉘우치게 되는 작업이었던 것 같습니다. 프로젝트 선정 단계에서 많은 고민을 하였으며 스스로에게 되묻는 시간이 많았습니다.

또한, 어떻게 해야 내 서비스 이용자의 비즈니스 서비스 웹사이트에 방문하는 사용자들의 기록을 가져올지에 대해 고민하며 많은 시간을 소모했습니다.

이렇게 진행을 해도 될까? 아니면 저렇게 진행을 해야할까? 라는 생각이 꼬리에 꼬리를 물고 작업 진도가 느려졌습니다. 하지만 어떻게든 프로젝트를 완성하기 위해 결단을 내렸던 순간이 많았습니다. 그리고 그 결단은 대체적으로 프로젝트의 방향에서 옳은 결정이었습니다.

항상 어느때에나 지나고나서 돌이켜보면 고민에 매몰되어 정작 중요한 작업은 놓치고 있었지 않았나 싶습니다. 이번 프로젝트는 고민과 실행 사이의 밸런스를 찾아갈 수 있는 그런 중요한 경험이었던 것 같습니다.

...
- [💪🏻 기술적 경험](#-기술적-경험)
  - [1. 어떻게 웹사이트 방문자의 페이지 이동 흐름을 추적할 수 있을까](#1-어떻게-웹사이트-방문자의-페이지-이동-흐름을-추적할-수-있을까)
    - [1-1. 문제: 초기접근, useLocation의 한계점](#1-1-문제-초기접근-uselocation의-한계점)
    ...
    - [1-4. 결과: 페이지 이동 흐름 추적 회고](#1-4-결과-페이지-이동-흐름-추적-회고)
